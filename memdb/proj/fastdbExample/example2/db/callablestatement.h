...
class CCallableStatement
{
  public:
	 ...
	 * @exception CSQLException 操作失败，具体原因请根据sqlcode查阅数据库错误代码说明
	 */
	virtual void setString(int nParamIndex, const std::string& Value, bool isRegOut=false)=0;
	 ...
	 * @exception CSQLException 操作失败，具体原因请根据sqlcode查阅数据库错误代码说明
	 */
	virtual void setInt64(int nParamIndex, int64 Value, bool isRegOut = false)=0;
	 ...
	 * @exception CSQLException 操作失败，具体原因请根据sqlcode查阅数据库错误代码说明
	 */
    virtual CAutoPtr<CResultSet> getNextResultSet()=0;
	 ...
	 * @exception CSQLException 操作失败，具体原因请根据sqlcode查阅数据库错误代码说明
	 */
    virtual std::string getString(int nIndex)=0;
	 ...
	 * @exception CSQLException 操作失败，具体原因请根据sqlcode查阅数据库错误代码说明
	 */
    virtual std::string getString(const char* pColumn)=0;
	 ...
	 * 返回参数索引ID的值	
	 * @param	nIndex: 索引ID
	 * @return	返回值类型为int64，64位整型
	 * @exception CSQLException 操作失败，具体原因请根据sqlcode查阅数据库错误代码说明
	 */
    virtual int64 getInt64(int nIndex)=0;
	 ...
	 * @exception CSQLException 操作失败，具体原因请根据sqlcode查阅数据库错误代码说明
	 */
    virtual int64 getInt64(const char* pParamName)=0;
