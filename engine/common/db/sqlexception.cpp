...
//////////////////////////////////////////////////////////////////////
CSQLException::CSQLException(int nSQLErrCode, const std::string& strErrDesc) : CMyException(strErrDesc),m_nSQLErrCode(nSQLErrCode),m_SQLError(nSQLErrCode, strErrDesc)
{
